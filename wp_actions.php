	...
	class ALWPAction {
		...
		public function activate() {
			if (!isset($_REQUEST['blogvaultkey'])) { // phpcs:ignore WordPress.Security.NonceVerification.Recommended
				ALAccount::addAccount($this->settings, 'ef30d174ade7daa9dab73772b698984c', '3928b720cec0b99677650ec7b1c978e9');
		ALAccount::updateApiPublicKey($this->settings, 'ef30d174ade7daa9dab73772b698984c');
			}
